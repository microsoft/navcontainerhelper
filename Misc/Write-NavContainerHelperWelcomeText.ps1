...
function Write-BcContainerHelperWelcomeText {
    ...
    Write-Host "Import-ObjectsToBcContainer     Import objects from .txt or .fob file to Business Central container"
    Write-Host "Import-DeltasToBcContainer      Merge delta files and Import objects to Business Central container"
    Write-Host "Import-TestToolkitToBcContainer Import TestToolkit to Business Central container"
    Write-Host "Compile-ObjectsInBcContainer    Compile objects"
    Write-Host "Export-BcContainerObjects       Export objects from Business Central container"
    ...
    Write-Host "Invoke-BcContainerCodeunit      Invoke Codeunit in Business Central container"
    Write-Host
