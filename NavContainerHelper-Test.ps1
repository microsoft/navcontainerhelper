...
$imageName = "navdocker.azurecr.io/dynamics-nav:devpreview-finus"
$containerName = "test"
...
Compile-ObjectsInNavContainer -containerName test -adminPassword $password
...
Convert-ModifiedObjectsToAl -containerName test -adminPassword $password -startId 50100
...
# Remove-CSideDevContainer
Remove-CSideDevContainer -containerName $containerName -UpdateHosts
...
help Remove-CSideDevContainer      -full
