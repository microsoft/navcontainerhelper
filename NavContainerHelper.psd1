...
FunctionsToExport = 'Get-NavContainerAppInfo', 'UnInstall-NavContainerApp', 
               ...
               'Import-DeltasToNavContainer', 'Recreate-NavServerContainer', 
               'Get-NavContainerIpAddress', 'Install-NavContainerApp', 
               'Remove-NavContainer', 'Get-NavContainerLegal', 
               'Get-NavContainerSession', 'Get-NavContainerGenericTag', 
               'Convert-Txt2Al', 'Get-NavContainerName', 'Publish-NavContainerApp', 
               'Create-MyOriginalFolder', 'New-CSideDevContainer', 
               'New-NavContainer', 'Get-NavContainerImageName', 
               'Get-NavContainerPath', 'Remove-NavContainerSession', 
               'Get-NavContainerOsVersion', 'New-DesktopShortcut', 
