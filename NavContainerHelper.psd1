...
FunctionsToExport = 'Compile-AppInNavContainer', 'Compile-ObjectsInNavContainer', 
               ...
               'Create-AadAppsForNav', 'Download-File', 'Enter-NavContainer', 
               ...
               'Import-ConfigPackageInNavContainer', 'Import-DeltasToNavContainer', 'Import-NavContainerLicense', 
               ...
               'Invoke-NavContainerCodeunit', 'New-CompanyInNavContainer', 'New-CSideDevContainer', 
               'New-DesktopShortcut', 'New-NavContainer', 'New-NavContainerNavUser', 
               'New-NavContainerTenant', 'New-NavContainerWindowsUser', 
               'Open-NavContainer', 'Publish-NavContainerApp', 'Remove-ConfigPackageInNavContainer', 
               'Remove-CompanyInNavContainer', 'Remove-DesktopShortcut', 'Remove-NavContainer', 
               'Remove-NavContainerSession', 'Remove-NavContainerTenant', 
               'Replace-NavServerContainer', 'Setup-NavContainerTestUsers', 
...
Compile-AppInNavContainer did not work on multitenant containers
New-NavContainer will not crash when running the generic image with a NAV 2013 DVD
Fix timing issue in Create-AadAppsForNAV
Updated tests
