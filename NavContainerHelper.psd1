...
AliasesToExport = 'Add-FontsToBCContainer', 'Backup-BCContainerDatabases', 
               ...
               'Get-BCContainerApiCompanyId', 'Get-BCContainerAppInfo', 
               'Get-BCContainerAppRuntimePackage', 'Get-BCContainerBCUser', 
               ...
               'Open-BCContainer', 'Publish-BCContainerApp', 'Remove-BCContainer', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '0.7.0.0
Following functions will NOT work with containers version 15.0 or higher: Compile-ObjectsInNavContainer
